  ...
  sizesext.forEach(function(sext) {
      typeext.forEach(function(text) {
          ...
          source.setAttribute("srcset", "".concat(path).concat(sext).concat(".").concat(text).concat(" 700w, ").concat(path).concat(sext).concat("@2x.")
                                          .concat(text).concat(" 1400w, ").concat(path).concat(sext).concat("@3x.").concat(text).concat(" 2100w"));
          source.setAttribute("sizes", sizes);
          picture.appendChild(source);
      });
  });
  var image = document.createElement("img");
  image.setAttribute("srcset", "".concat(path).concat("_large.png 700w, ").concat(path).concat("_large@2x.png 1400w, ").concat(path).concat("_large@3x.png 2100w"));
  image.setAttribute("src", "".concat(path).concat("_large@3x.png"));
